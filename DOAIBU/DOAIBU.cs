...
public class DOAIBU : Bot
{
    ...
    DOAIBU() : base(BotInfo.FromFile("DOAIBU.json")) { }

    public override void Run()
    {
        Console.WriteLine("DOAIBU DOAIBU DOAIBU 🐶! |---| round: " + RoundNumber);
    ...
    public override void OnTick(TickEvent e)
    {
        ...
        for (int i = bullets.Count - 1; i >= 0; i--)
        {
            ...
            g.FillRectangle(Brushes.White, (float)bullet.X, (float)bullet.Y, (float)(3 * bullet.Power), (float)(3 * bullet.Power));
    ...
    public override void OnScannedBot(ScannedBotEvent e)
    {
        ...
        var g = Graphics;
        Pen redPen = new Pen(Brushes.White);
